...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_hillu_go_yara_v4",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/hillu/go-yara/v4",
        sum = "h1:HGqUN3ORUduWZbb95RQjut4UzavGDbtt/C6SnGB3Amk=",
        version = "v4.3.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:p2Uw3+6fGG53CwdU2Dz0T6bOycdb2+bAFAa3ymwWVkM=",
        version = "v0.25.13",
    )
    go_repository(
        name = "com_github_likexian_whois",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/likexian/whois",
        sum = "h1:6vTMI8n9s1eJdmcO4R9h1x99aQWIZZX1CD3am68gApU=",
        version = "v1.15.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:cnRXLxs8UAe9+pgQ9aazgGw+cn3wixfhu6Wk7P6BqkQ=",
        version = "v1.10.0",
    )
    go_repository(
