...
CREATE TABLE request_description (
  ...
  ai_shell_commands  VARCHAR(10000) default '',
  ai_mitre_attack  VARCHAR(2048) default '',
  ai_targeted_parameter  VARCHAR(10000) default '',
...
CREATE TABLE llm_code_execution (
  ...
  snippet            BYTEA NOT NULL DEFAULT ''::bytea,
...
CREATE INDEX requests_has_payload_idx ON request (
  has_payload
);
