...
The rule's request_purpose must be one of: EXPLOITATION, RECON, UNKNOWN.`,
			Parameters: map[string]any{
				...
				"properties": map[string]any{
					...
					"rule": map[string]any{
						...
						"properties": map[string]any{
							...
							"uri_matching":    map[string]any{"type": "string", "enum": []string{"none", "exact", "prefix", "suffix", "regex", "contains"}},
							"body":            map[string]any{"type": "string"},
							"body_matching":   map[string]any{"type": "string", "enum": []string{"none", "exact", "prefix", "suffix", "regex", "contains"}},
				...
				"required": []string{"content", "rule", "description", "links"},
			},
