...
type Request struct {
	...
	TriageInitialDurationMs int64                    `ksql:"triage_initial_duration_ms" json:"triage_initial_duration_ms" doc:"Duration in ms of the initial triage LLM call"`
	TriageTotalDurationMs   int64                    `ksql:"triage_total_duration_ms" json:"triage_total_duration_ms" doc:"Total wall-clock time in ms of the preprocess step"`
