...
func (x *ParsedURL) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
var file_backend_service_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x22, 0x5d, 0x0a, 0x12, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x50, 0x72, 0x6f,
	...
	0x73, 0x74, 0x22, 0x2f, 0x0a, 0x13, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x50, 0x72, 0x6f, 0x62,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x32, 0x4c, 0x0a, 0x0e, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x53, 0x65,
...
var file_backend_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_backend_service_proto_goTypes = []interface{}{
	...
	(*HandleProbeRequest)(nil),  // 3: HandleProbeRequest
	(*HandleProbeResponse)(nil), // 4: HandleProbeResponse
}
var file_backend_service_proto_depIdxs = []int32{
	...
	2, // 3: HandleProbeRequest.request:type_name -> HttpRequest
	3, // 4: BackendService.HandleProbe:input_type -> HandleProbeRequest
	4, // 5: BackendService.HandleProbe:output_type -> HandleProbeResponse
